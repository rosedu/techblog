...
doDeploy _ = do
  ...
  _ <- system "git rm *.html"
  _ <- system "git rm -rf css/"
  _ <- system "git rm -rf font/"
  _ <- system "git rm -rf images/"
  _ <- system "git rm -rf res/"
  _ <- system "git rm -rf tags/"
  _ <- system "git rm -rf people/"
